...
- **Streaming hours**: 2
- **Ioun Stone of Protection (Harmonious)** *(rare, requires attunement)* — a dusty-rose prism that orbits your head and grants +1 AC; the *harmonious* property means attuning takes only 1 minute. Taken from Marlax himself.
- **Spell Scroll of Calm Emotions** *(uncommon)* — a 2nd-level spell scroll (save DC 13, attack +5).
