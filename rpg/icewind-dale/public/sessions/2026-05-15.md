...
**Magic items:** Wand of Magic Missiles (recovered from the Remorhaz's stomach — survived the heat because it was magical).
**Consumables:** Healing potion (Dr. Medicine crafted during tribe prep).
**Trade goods:** Remorhaz hide (traded to the Coldpeak blacksmith for gold equivalent); two bear traps (traded from the blacksmith in exchange for forge work).
**Gold:** *(TBD — to be added before publishing)*
**Common magic item:** Talking Doll *(will discuss during next session)*
