...
also_known_as:
  - Shaping House
  - the crèche
image: /rpg/icewind-dale/public/locations/images/shaping-house.png
image_prompt: "[interior] a row of small children's beds with tattered decaying bedding, old forgotten toys scattered on the floor between them, dim warm light from an unseen source, cold stone walls, long abandoned"
---

A Netherese structure near the [**Standing Stones**](standing-stones), visible from the research camp. The top floors are gone — not collapsed, not destroyed by weather or violence. *Sheared*, as if something took a perfectly level cut and removed everything above it. The cut edge is clean. Whatever took the upper floors did not damage what remained below.
...
- The ghost of Igenio has dissipated. The broom has been claimed. The space is empty and quiet.
- Warm, defensible, and hidden from the surface. The sheared-off upper approach is the only obvious entrance.
- Could serve as a base of operations. The tribe does not know about it.
- The hidey hole is still intact.
